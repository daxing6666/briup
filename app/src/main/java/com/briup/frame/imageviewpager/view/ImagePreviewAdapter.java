package com.briup.frame.imageviewpager.view;
...
import com.briup.R;
import com.briup.frame.imageviewpager.ImagePreview;
import com.briup.frame.imageviewpager.bean.ImageInfo;
import com.briup.frame.imageviewpager.glide.FileTarget;
import com.briup.frame.imageviewpager.glide.ImageLoader;
import com.briup.frame.imageviewpager.view.helper.FingerDragHelper;
import com.briup.frame.imageviewpager.view.helper.SubsamplingScaleImageViewDragClose;
import com.briup.frame.utils.ImageUtil;
import com.briup.frame.utils.NetworkUtil;
import com.briup.frame.utils.Print;
import com.briup.frame.utils.ToastUtil;
...
public class ImagePreviewAdapter extends PagerAdapter {
  ...
  public void loadOrigin(final ImageInfo imageInfo) {
    if (imageHashMap.get(imageInfo.getOriginUrl()) != null) {
      ...
      if (cacheFile != null && cacheFile.exists()) {
        ...
        com.briup.frame.imageviewpager.view.helper.ImageSource small = null;
        if (smallCacheFile != null && smallCacheFile.exists()) {
          String smallImagePath = smallCacheFile.getAbsolutePath();
          small = com.briup.frame.imageviewpager.view.helper.ImageSource.bitmap(ImageUtil.getImageBitmap(smallImagePath, ImageUtil.getBitmapDegree(smallImagePath)));
        ...
        com.briup.frame.imageviewpager.view.helper.ImageSource origin =
                com.briup.frame.imageviewpager.view.helper.ImageSource.uri(imagePath);
  ...
  public Object instantiateItem(@NonNull ViewGroup container, final int position) {
    ...
    if (cacheFile != null && cacheFile.exists()) {
      ...
      imageView.setImage(com.briup.frame.imageviewpager.view.helper.ImageSource.uri(Uri.fromFile(new File(cacheFile.getAbsolutePath()))));
            ...
            public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<File> target,
              ...
              Glide.with(activity).downloadOnly().load(url).addListener(new RequestListener<File>() {
                ...
                public boolean onResourceReady(File resource, Object model, Target<File> target, DataSource dataSource,
                  ...
                  imageView.setImage(com.briup.frame.imageviewpager.view.helper.ImageSource.uri(Uri.fromFile(new File(resource.getAbsolutePath()))));
                  progressBar.setVisibility(View.GONE);
                  return true;
                }
              }).into(new FileTarget() {
